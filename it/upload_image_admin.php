...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['image'])) {
    ...
    $firebaseStoragePath = 'admin_page/admin_background/' . $fileName; // Changed to admin_background
    ...
    $database->getReference('admin_page/admin_backgroundImage')->set($imageUrl); // Changed to admin_backgroundImage
