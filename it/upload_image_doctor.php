...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['image'])) {
    ...
    $firebaseStoragePath = 'doctor_page/doctor_background/' . $fileName; // Changed to doctor_background
    ...
    $database->getReference('doctor_page/doctor_backgroundImage')->set($imageUrl); // Changed to doctor_backgroundImage
